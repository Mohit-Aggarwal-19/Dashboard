...
import { concatMap, ObjectUnsubscribedError, pipe, tap } from "rxjs";
    ...
    this._fetchDataFromAPI.getData().pipe(
      tap((res) => {
        ...
        data.objects.default.geometries.forEach((elementJSON: { properties: { [x: string]: any; }; }) => {
          ...
          //     (typeof this.Deaths[elementJSON.properties["name"]] !== 'undefined') ? elementMapData[1] = this.Deaths[elementJSON.properties["name"]] : elementMapData[1] = 0;
          //     console.log(elementMapData[1]);
          //   }
          // });
